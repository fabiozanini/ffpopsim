...
class tree_node(object):
    ...
    def _set_crossover_chunk(self, *args, **kwargs):
        """_set_crossover_chunk(self, int value, int i)"""
...
class haploid_highd(object):
    ...
    **Note**: fitness is not a phenotypic trait directly, but rather a function of *all*
    ...
    def _set_tree_in_genealogy(self, *args, **kwargs):
        """_set_tree_in_genealogy(self, int locus, rooted_tree tree)"""
    ...
    def _set_newGeneration_in_genealogy(self, *args, **kwargs):
        """_set_newGeneration_in_genealogy(self, int locus, vector_tree_node newGeneration)"""
...
class hivgene(object):
    ...
    def __init__(self, start_in = 0, end_in = 10000, second_start_in = 0, 
    second_end_in = 0): 
        """Structure for an HIV gene."""
